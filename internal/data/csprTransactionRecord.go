...
func (r *CsprTransactionRecord) Version() string {
	return "20240104"
}
...
type CsprTransactionRecordRepo interface {
	...
	PageBatchSaveOrUpdateSelectiveById(context.Context, string, []*CsprTransactionRecord, int) (int64, error)
...
func (r *CsprTransactionRecordRepoImpl) PageBatchSaveOrUpdateSelectiveByColumns(ctx context.Context, tableName string, columns []string, txRecords []*CsprTransactionRecord, pageSize int) (int64, error) {
...
func (r *CsprTransactionRecordRepoImpl) PageBatchSaveOrUpdateSelectiveById(ctx context.Context, tableName string, txRecords []*CsprTransactionRecord, pageSize int) (int64, error) {
