...
var ProviderSet = wire.NewSet(NewBtcTransactionRecordRepo, NewEvmTransactionRecordRepo, NewStcTransactionRecordRepo, NewTrxTransactionRecordRepo, NewAptTransactionRecordRepo, NewSuiTransactionRecordRepo, NewSolTransactionRecordRepo, NewCkbTransactionRecordRepo, NewCsprTransactionRecordRepo, NewUserRecordRepo, NewUserAssetRepo, NewUserAssetHistoryRepo, NewAtomTransactionRecordRepo, NewDappApproveRecordRepo, NewDotTransactionRecordRepo, NewTransactionStatisticRepo, NewNervosCellRecordRepo, NewUtxoUnspentRecordRepo, NewUserNftAssetRepo, NewNftRecordHistoryRepo, NewUserSendRawHistoryRepo, NewMarketCoinHistoryRepo, NewBundle)
