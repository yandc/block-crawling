...
type PlatInfo struct {
	...
	TokenPrice     string   `protobuf:"bytes,10,opt,name=tokenPrice,proto3" json:"tokenPrice,omitempty"`
	// 可以安全的进行并发爬块的高度差（即不用考虑分叉的高度），即：
	// 「链上高度 - 当前高度」大于此值才开始并发爬块。
	SafelyConcurrentBlockDelta *int32 `protobuf:"varint,11,opt,name=safelyConcurrentBlockDelta,proto3,oneof" json:"safelyConcurrentBlockDelta,omitempty"`
	// 爬块最大并发
	MaxConcurrency *int32 `protobuf:"varint,12,opt,name=maxConcurrency,proto3,oneof" json:"maxConcurrency,omitempty"`
	// 块高差报警阈值，爬块高度和链上高度的差大于此值进行报警。
	MonitorHeightAlarmThr *int32 `protobuf:"varint,13,opt,name=monitorHeightAlarmThr,proto3,oneof" json:"monitorHeightAlarmThr,omitempty"`
	// 多个节点轮询并发，否则每次只使用一个节点进行并发。
	RoundRobinConcurrent *bool `protobuf:"varint,14,opt,name=roundRobinConcurrent,proto3,oneof" json:"roundRobinConcurrent,omitempty"`
	// 备用节点，用于特定错误重试。
	StandbyRPCURL []string `protobuf:"bytes,15,rep,name=standbyRPCURL,proto3" json:"standbyRPCURL,omitempty"`
	// 是否启动代理，启用后将依次使用代理池中的代理进行访问节点。
	EnableProxy *bool `protobuf:"varint,16,opt,name=enableProxy,proto3,oneof" json:"enableProxy,omitempty"`
	// 处理交易的并发，实际会开启的 Goroutine 最大可能达到 maxConcurrency * handlingTxConcurrency。
	HandlingTxConcurrency *int32 `protobuf:"varint,17,opt,name=handlingTxConcurrency,proto3,oneof" json:"handlingTxConcurrency,omitempty"`
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0x9b, 0x06, 0x0a, 0x08, 0x50, 0x6c, 0x61, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14,
	...
	,
