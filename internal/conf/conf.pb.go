...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x6c, 0x22, 0xd8, 0x03, 0x0a, 0x04, 0x4c, 0x61, 0x72, 0x6b, 0x12, 0x26, 0x0a, 0x0e, 0x6c, 0x61,
	...
	0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x3b, 0x0a, 0x0d, 0x4c,
	...
	0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc2, 0x01, 0x0a,
	...
	0x09, 0x52, 0x09, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4b, 0x65, 0x79, 0x22, 0xb6, 0x08, 0x0a,
	...
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x18, 0x0d, 0x20, 0x01,
	...
	0x6c, 0x65, 0x4b, 0x61, 0x6e, 0x62, 0x61, 0x6e, 0x18, 0x17, 0x20, 0x01, 0x28, 0x08, 0x48, 0x07,
	...
	0x50, 0x43, 0x55, 0x52, 0x4c, 0x18, 0x18, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x6b, 0x61, 0x6e,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Logger)(nil),              // 9: kratos.api.Logger
	(*Transaction)(nil),         // 10: kratos.api.Transaction
	(*PlatInfo)(nil),            // 11: kratos.api.PlatInfo
	(*LarkSubscription)(nil),    // 12: kratos.api.LarkSubscription
	nil,                         // 13: kratos.api.Bootstrap.InnerNodeListEntry
	nil,                         // 14: kratos.api.Bootstrap.InnerPublicNodeListEntry
	nil,                         // 15: kratos.api.Bootstrap.PlatformEntry
	nil,                         // 16: kratos.api.Bootstrap.PlatformTestEntry
	(*Server_HTTP)(nil),         // 17: kratos.api.Server.HTTP
	(*Server_GRPC)(nil),         // 18: kratos.api.Server.GRPC
	(*Data_Pool)(nil),           // 19: kratos.api.Data.Pool
	(*Data_Database)(nil),       // 20: kratos.api.Data.Database
	(*Data_Redis)(nil),          // 21: kratos.api.Data.Redis
	nil,                         // 22: kratos.api.App.FeaturedCustomChainEntry
	nil,                         // 23: kratos.api.Lark.LarkUidsEntry
	nil,                         // 24: kratos.api.Lark.LarkSubscriptionsEntry
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 5: kratos.api.Bootstrap.logger:type_name -> kratos.api.Logger
	10, // 6: kratos.api.Bootstrap.transaction:type_name -> kratos.api.Transaction
	13, // 7: kratos.api.Bootstrap.innerNodeList:type_name -> kratos.api.Bootstrap.InnerNodeListEntry
	14, // 8: kratos.api.Bootstrap.innerPublicNodeList:type_name -> kratos.api.Bootstrap.InnerPublicNodeListEntry
	15, // 9: kratos.api.Bootstrap.platform:type_name -> kratos.api.Bootstrap.PlatformEntry
	16, // 10: kratos.api.Bootstrap.platformTest:type_name -> kratos.api.Bootstrap.PlatformTestEntry
	17, // 11: kratos.api.Server.http:type_name -> kratos.api.Server.HTTP
	18, // 12: kratos.api.Server.grpc:type_name -> kratos.api.Server.GRPC
	20, // 13: kratos.api.Data.database:type_name -> kratos.api.Data.Database
	21, // 14: kratos.api.Data.redis:type_name -> kratos.api.Data.Redis
	20, // 15: kratos.api.Data.user:type_name -> kratos.api.Data.Database
	20, // 16: kratos.api.Data.kanban:type_name -> kratos.api.Data.Database
	22, // 17: kratos.api.App.featuredCustomChain:type_name -> kratos.api.App.FeaturedCustomChainEntry
	...
	23, // 21: kratos.api.Lark.larkUids:type_name -> kratos.api.Lark.LarkUidsEntry
	24, // 22: kratos.api.Lark.larkSubscriptions:type_name -> kratos.api.Lark.LarkSubscriptionsEntry
	11, // 23: kratos.api.Bootstrap.InnerNodeListEntry.value:type_name -> kratos.api.PlatInfo
	11, // 24: kratos.api.Bootstrap.InnerPublicNodeListEntry.value:type_name -> kratos.api.PlatInfo
	11, // 25: kratos.api.Bootstrap.PlatformEntry.value:type_name -> kratos.api.PlatInfo
	11, // 26: kratos.api.Bootstrap.PlatformTestEntry.value:type_name -> kratos.api.PlatInfo
	...
	19, // 29: kratos.api.Data.Database.pool:type_name -> kratos.api.Data.Pool
	25, // 30: kratos.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	25, // 31: kratos.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
	12, // 32: kratos.api.Lark.LarkSubscriptionsEntry.value:type_name -> kratos.api.LarkSubscription
...
func file_conf_conf_proto_init() {
	...
	file_conf_conf_proto_msgTypes[11].OneofWrappers = []interface{}{}
	type x struct{}
