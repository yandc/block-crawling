...
type PlatInfo struct {
	...
	RpcURL         []string `protobuf:"bytes,9,rep,name=rpcURL,proto3" json:"rpcURL,omitempty"`
	HttpURL        []string `protobuf:"bytes,10,rep,name=httpURL,proto3" json:"httpURL,omitempty"`
	TokenPrice     string   `protobuf:"bytes,11,opt,name=tokenPrice,proto3" json:"tokenPrice,omitempty"`
	// chainId 区分链唯一标识
	...
	SafelyConcurrentBlockDelta *int32 `protobuf:"varint,14,opt,name=safelyConcurrentBlockDelta,proto3,oneof" json:"safelyConcurrentBlockDelta,omitempty"`
	// 爬块最大并发
	MaxConcurrency *int32 `protobuf:"varint,15,opt,name=maxConcurrency,proto3,oneof" json:"maxConcurrency,omitempty"`
	// 块高差报警阈值，爬块高度和链上高度的差大于此值进行报警。
	MonitorHeightAlarmThr *int32 `protobuf:"varint,16,opt,name=monitorHeightAlarmThr,proto3,oneof" json:"monitorHeightAlarmThr,omitempty"`
	// 多个节点轮询并发，否则每次只使用一个节点进行并发。
	RoundRobinConcurrent *bool `protobuf:"varint,17,opt,name=roundRobinConcurrent,proto3,oneof" json:"roundRobinConcurrent,omitempty"`
	// 备用节点，用于特定错误重试。
	StandbyRPCURL []string `protobuf:"bytes,18,rep,name=standbyRPCURL,proto3" json:"standbyRPCURL,omitempty"`
	// 是否启动代理，启用后将依次使用代理池中的代理进行访问节点。
	EnableProxy *bool `protobuf:"varint,19,opt,name=enableProxy,proto3,oneof" json:"enableProxy,omitempty"`
	// 处理交易的并发，实际会开启的 Goroutine 最大可能达到 maxConcurrency * handlingTxConcurrency。
	HandlingTxConcurrency *int32 `protobuf:"varint,20,opt,name=handlingTxConcurrency,proto3,oneof" json:"handlingTxConcurrency,omitempty"`
	// 从数据库读取块高时允许和链上块高的最大间隔值，超过当前阈值则直接使用链上块高。
	MaxAllowedHeightGap *int32 `protobuf:"varint,21,opt,name=maxAllowedHeightGap,proto3,oneof" json:"maxAllowedHeightGap,omitempty"`
	// 启用看板全量存储交易数据。
	EnableKanban *bool `protobuf:"varint,22,opt,name=enableKanban,proto3,oneof" json:"enableKanban,omitempty"`
	// 全节点：用于补全看板数据的 RPC 节点。
	KanbanFullRPCURL []string `protobuf:"bytes,23,rep,name=kanbanFullRPCURL,proto3" json:"kanbanFullRPCURL,omitempty"`
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xed, 0x01, 0x0a, 0x03, 0x41, 0x70, 0x70,
	...
	,
	...
	0x72, 0x79, 0x52, 0x11, 0x6c, 0x61, 0x72, 0x6b, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x3b, 0x0a, 0x0d, 0x4c, 0x61, 0x72, 0x6b, 0x55, 0x69, 0x64,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x1a, 0x62, 0x0a, 0x16, 0x4c, 0x61, 0x72, 0x6b, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72,
	...
	0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4c, 0x61, 0x72, 0x6b, 0x53,
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc2, 0x01, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x67, 0x65,
	...
	0x65, 0x73, 0x73, 0x4b, 0x65, 0x79, 0x22, 0x9c, 0x08, 0x0a, 0x08, 0x50, 0x6c, 0x61, 0x74, 0x49,
	...
	0x16, 0x0a, 0x06, 0x72, 0x70, 0x63, 0x55, 0x52, 0x4c, 0x18, 0x09, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x06, 0x72, 0x70, 0x63, 0x55, 0x52, 0x4c, 0x12, 0x18, 0x0a, 0x07, 0x68, 0x74, 0x74, 0x70, 0x55,
	0x52, 0x4c, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x68, 0x74, 0x74, 0x70, 0x55, 0x52,
	0x4c, 0x12, 0x1e, 0x0a, 0x0a, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x72, 0x69, 0x63, 0x65, 0x18,
	0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x72, 0x69, 0x63,
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x18, 0x0c, 0x20, 0x01,
	...
	0x61, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x1a, 0x73, 0x61, 0x66, 0x65, 0x6c,
	...
	0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x41, 0x6c, 0x61, 0x72, 0x6d, 0x54, 0x68, 0x72, 0x18, 0x10,
	...
	0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x11, 0x20, 0x01, 0x28, 0x08, 0x48, 0x03,
	...
	0x6e, 0x64, 0x62, 0x79, 0x52, 0x50, 0x43, 0x55, 0x52, 0x4c, 0x18, 0x12, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0d, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x62, 0x79, 0x52, 0x50, 0x43, 0x55, 0x52, 0x4c, 0x12,
	0x25, 0x0a, 0x0b, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x18, 0x13,
	...
	0x14, 0x20, 0x01, 0x28, 0x05, 0x48, 0x05, 0x52, 0x15, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x69, 0x6e,
	...
	,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*AddressServer)(nil),       // 4: kratos.api.AddressServer
	(*Lark)(nil),                // 5: kratos.api.Lark
	(*Logger)(nil),              // 6: kratos.api.Logger
	(*Transaction)(nil),         // 7: kratos.api.Transaction
	(*PlatInfo)(nil),            // 8: kratos.api.PlatInfo
	(*LarkSubscription)(nil),    // 9: kratos.api.LarkSubscription
	nil,                         // 10: kratos.api.Bootstrap.InnerNodeListEntry
	nil,                         // 11: kratos.api.Bootstrap.InnerPublicNodeListEntry
	nil,                         // 12: kratos.api.Bootstrap.PlatformEntry
	nil,                         // 13: kratos.api.Bootstrap.PlatformTestEntry
	(*Server_HTTP)(nil),         // 14: kratos.api.Server.HTTP
	(*Server_GRPC)(nil),         // 15: kratos.api.Server.GRPC
	(*Data_Pool)(nil),           // 16: kratos.api.Data.Pool
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 3: kratos.api.Bootstrap.addressServer:type_name -> kratos.api.AddressServer
	5,  // 4: kratos.api.Bootstrap.lark:type_name -> kratos.api.Lark
	6,  // 5: kratos.api.Bootstrap.logger:type_name -> kratos.api.Logger
	7,  // 6: kratos.api.Bootstrap.transaction:type_name -> kratos.api.Transaction
	10, // 7: kratos.api.Bootstrap.innerNodeList:type_name -> kratos.api.Bootstrap.InnerNodeListEntry
	11, // 8: kratos.api.Bootstrap.innerPublicNodeList:type_name -> kratos.api.Bootstrap.InnerPublicNodeListEntry
	12, // 9: kratos.api.Bootstrap.platform:type_name -> kratos.api.Bootstrap.PlatformEntry
	13, // 10: kratos.api.Bootstrap.platformTest:type_name -> kratos.api.Bootstrap.PlatformTestEntry
	14, // 11: kratos.api.Server.http:type_name -> kratos.api.Server.HTTP
	15, // 12: kratos.api.Server.grpc:type_name -> kratos.api.Server.GRPC
	17, // 13: kratos.api.Data.database:type_name -> kratos.api.Data.Database
	18, // 14: kratos.api.Data.redis:type_name -> kratos.api.Data.Redis
	17, // 15: kratos.api.Data.user:type_name -> kratos.api.Data.Database
	17, // 16: kratos.api.Data.kanban:type_name -> kratos.api.Data.Database
	...
	8,  // 19: kratos.api.Bootstrap.InnerNodeListEntry.value:type_name -> kratos.api.PlatInfo
	8,  // 20: kratos.api.Bootstrap.InnerPublicNodeListEntry.value:type_name -> kratos.api.PlatInfo
	8,  // 21: kratos.api.Bootstrap.PlatformEntry.value:type_name -> kratos.api.PlatInfo
	8,  // 22: kratos.api.Bootstrap.PlatformTestEntry.value:type_name -> kratos.api.PlatInfo
	21, // 23: kratos.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	21, // 24: kratos.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	16, // 25: kratos.api.Data.Database.pool:type_name -> kratos.api.Data.Pool
	...
	9,  // 28: kratos.api.Lark.LarkSubscriptionsEntry.value:type_name -> kratos.api.LarkSubscription
...
func file_conf_conf_proto_init() {
	...
	file_conf_conf_proto_msgTypes[8].OneofWrappers = []interface{}{}
	type x struct{}
