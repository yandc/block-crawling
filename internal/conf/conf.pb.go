...
type PlatInfo struct {
	...
	SafelyConcurrentBlockDelta *int32 `protobuf:"varint,12,opt,name=safelyConcurrentBlockDelta,proto3,oneof" json:"safelyConcurrentBlockDelta,omitempty"`
	// 爬块最大并发
	MaxConcurrency *int32 `protobuf:"varint,13,opt,name=maxConcurrency,proto3,oneof" json:"maxConcurrency,omitempty"`
	// 块高差报警阈值，爬块高度和链上高度的差大于此值进行报警。
	MonitorHeightAlarmThr *int32 `protobuf:"varint,14,opt,name=monitorHeightAlarmThr,proto3,oneof" json:"monitorHeightAlarmThr,omitempty"`
	// 多个节点轮询并发，否则每次只使用一个节点进行并发。
	RoundRobinConcurrent *bool `protobuf:"varint,15,opt,name=roundRobinConcurrent,proto3,oneof" json:"roundRobinConcurrent,omitempty"`
	// 备用节点，用于特定错误重试。
	StandbyRPCURL []string `protobuf:"bytes,16,rep,name=standbyRPCURL,proto3" json:"standbyRPCURL,omitempty"`
	// 是否启动代理，启用后将依次使用代理池中的代理进行访问节点。
	EnableProxy *bool `protobuf:"varint,17,opt,name=enableProxy,proto3,oneof" json:"enableProxy,omitempty"`
	// 处理交易的并发，实际会开启的 Goroutine 最大可能达到 maxConcurrency * handlingTxConcurrency。
	HandlingTxConcurrency *int32 `protobuf:"varint,18,opt,name=handlingTxConcurrency,proto3,oneof" json:"handlingTxConcurrency,omitempty"`
	// 从数据库读取块高时允许和链上块高的最大间隔值，超过当前阈值则直接使用链上块高。
	MaxAllowedHeightGap *int32 `protobuf:"varint,19,opt,name=maxAllowedHeightGap,proto3,oneof" json:"maxAllowedHeightGap,omitempty"`
	// chainId 区分链唯一标识
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xcf, 0x01, 0x0a, 0x03, 0x41, 0x70, 0x70, 0x12, 0x12, 0x0a,
	...
	0x50, 0x72, 0x6f, 0x78, 0x69, 0x65, 0x73, 0x22, 0x51, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x72, 0x65,
	...
	0x76, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0xd8, 0x03, 0x0a, 0x04, 0x4c,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x3b, 0x0a, 0x0d, 0x4c, 0x61, 0x72, 0x6b, 0x55, 0x69, 0x64, 0x73,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc2, 0x01, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x67, 0x65, 0x72,
	0x12, 0x14, 0x0a, 0x05, 0x44, 0x45, 0x42, 0x55, 0x47, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x05, 0x44, 0x45, 0x42, 0x55, 0x47, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61,
	...
	,
	...
	0x09, 0x52, 0x07, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x26, 0x0a, 0x0e, 0x6e, 0x61,
	0x74, 0x69, 0x76, 0x65, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0e, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x63, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x18, 0x07, 0x20, 0x01,
	...
	,
	...
	0x6c, 0x6f, 0x77, 0x65, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x47, 0x61, 0x70, 0x22, 0x26,
	0x0a, 0x10, 0x4c, 0x61, 0x72, 0x6b, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x04, 0x75, 0x69, 0x64, 0x73, 0x42, 0x23, 0x5a, 0x21, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2d,
	0x63, 0x72, 0x61, 0x77, 0x6c, 0x69, 0x6e, 0x67, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61,
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	19, // 16: kratos.api.Lark.larkUids:type_name -> kratos.api.Lark.LarkUidsEntry
	20, // 17: kratos.api.Lark.larkSubscriptions:type_name -> kratos.api.Lark.LarkSubscriptionsEntry
	8,  // 18: kratos.api.Bootstrap.InnerNodeListEntry.value:type_name -> kratos.api.PlatInfo
	8,  // 19: kratos.api.Bootstrap.InnerPublicNodeListEntry.value:type_name -> kratos.api.PlatInfo
	8,  // 20: kratos.api.Bootstrap.PlatformEntry.value:type_name -> kratos.api.PlatInfo
	8,  // 21: kratos.api.Bootstrap.PlatformTestEntry.value:type_name -> kratos.api.PlatInfo
	21, // 22: kratos.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	21, // 23: kratos.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	16, // 24: kratos.api.Data.Database.pool:type_name -> kratos.api.Data.Pool
	...
	9,  // 27: kratos.api.Lark.LarkSubscriptionsEntry.value:type_name -> kratos.api.LarkSubscription
