...
var file_conf_conf_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x23, 0x5a, 0x21, 0x62,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*ChainData)(nil),           // 14: kratos.api.ChainData
	nil,                         // 15: kratos.api.Bootstrap.InnerNodeListEntry
	nil,                         // 16: kratos.api.Bootstrap.InnerPublicNodeListEntry
	nil,                         // 17: kratos.api.Bootstrap.PlatformEntry
	nil,                         // 18: kratos.api.Bootstrap.PlatformTestEntry
	nil,                         // 19: kratos.api.Bootstrap.EventLogWhiteListEntry
	(*Server_HTTP)(nil),         // 20: kratos.api.Server.HTTP
	(*Server_GRPC)(nil),         // 21: kratos.api.Server.GRPC
	(*Data_Pool)(nil),           // 22: kratos.api.Data.Pool
	(*Data_Database)(nil),       // 23: kratos.api.Data.Database
	(*Data_Redis)(nil),          // 24: kratos.api.Data.Redis
	nil,                         // 25: kratos.api.App.FeaturedCustomChainEntry
	nil,                         // 26: kratos.api.Lark.LarkUidsEntry
	nil,                         // 27: kratos.api.Lark.LarkSubscriptionsEntry
	nil,                         // 28: kratos.api.Lark.LarkBotsEntry
	nil,                         // 29: kratos.api.ChainData.GasCoefficientEntry
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	15, // 7: kratos.api.Bootstrap.innerNodeList:type_name -> kratos.api.Bootstrap.InnerNodeListEntry
	16, // 8: kratos.api.Bootstrap.innerPublicNodeList:type_name -> kratos.api.Bootstrap.InnerPublicNodeListEntry
	17, // 9: kratos.api.Bootstrap.platform:type_name -> kratos.api.Bootstrap.PlatformEntry
	18, // 10: kratos.api.Bootstrap.platformTest:type_name -> kratos.api.Bootstrap.PlatformTestEntry
	19, // 11: kratos.api.Bootstrap.eventLogWhiteList:type_name -> kratos.api.Bootstrap.EventLogWhiteListEntry
	20, // 12: kratos.api.Server.http:type_name -> kratos.api.Server.HTTP
	21, // 13: kratos.api.Server.grpc:type_name -> kratos.api.Server.GRPC
	23, // 14: kratos.api.Data.database:type_name -> kratos.api.Data.Database
	24, // 15: kratos.api.Data.redis:type_name -> kratos.api.Data.Redis
	23, // 16: kratos.api.Data.user:type_name -> kratos.api.Data.Database
	25, // 17: kratos.api.App.featuredCustomChain:type_name -> kratos.api.App.FeaturedCustomChainEntry
	4,  // 18: kratos.api.App.cmq:type_name -> kratos.api.CMQ
	14, // 19: kratos.api.App.chainData:type_name -> kratos.api.ChainData
	5,  // 20: kratos.api.CMQ.queues:type_name -> kratos.api.CMQueues
	6,  // 21: kratos.api.CMQueues.swapPairs:type_name -> kratos.api.CMQueue
	6,  // 22: kratos.api.CMQueues.benfenPairs:type_name -> kratos.api.CMQueue
	26, // 23: kratos.api.Lark.larkUids:type_name -> kratos.api.Lark.LarkUidsEntry
	27, // 24: kratos.api.Lark.larkSubscriptions:type_name -> kratos.api.Lark.LarkSubscriptionsEntry
	28, // 25: kratos.api.Lark.larkBots:type_name -> kratos.api.Lark.LarkBotsEntry
	29, // 26: kratos.api.ChainData.gasCoefficient:type_name -> kratos.api.ChainData.GasCoefficientEntry
	12, // 27: kratos.api.Bootstrap.InnerNodeListEntry.value:type_name -> kratos.api.PlatInfo
	12, // 28: kratos.api.Bootstrap.InnerPublicNodeListEntry.value:type_name -> kratos.api.PlatInfo
	12, // 29: kratos.api.Bootstrap.PlatformEntry.value:type_name -> kratos.api.PlatInfo
	12, // 30: kratos.api.Bootstrap.PlatformTestEntry.value:type_name -> kratos.api.PlatInfo
	30, // 31: kratos.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	30, // 32: kratos.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	22, // 33: kratos.api.Data.Database.pool:type_name -> kratos.api.Data.Pool
	30, // 34: kratos.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	30, // 35: kratos.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
	13, // 36: kratos.api.Lark.LarkSubscriptionsEntry.value:type_name -> kratos.api.LarkSubscription
	9,  // 37: kratos.api.Lark.LarkBotsEntry.value:type_name -> kratos.api.LarkBot
