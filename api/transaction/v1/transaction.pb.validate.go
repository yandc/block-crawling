...
func (m *AssetResponse) validate(all bool) error {
	...
	// no validation rules for IsSyncToChain

	// no validation rules for SyncToChainTs
...
// Validate checks the field values on ListHasBalanceDimensionRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListHasBalanceDimensionRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListHasBalanceDimensionRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// ListHasBalanceDimensionRequestMultiError, or nil if none found.
func (m *ListHasBalanceDimensionRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *ListHasBalanceDimensionRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ListHasBalanceDimensionRequestMultiError(errors)
	}

	return nil
}

// ListHasBalanceDimensionRequestMultiError is an error wrapping multiple
// validation errors returned by ListHasBalanceDimensionRequest.ValidateAll()
// if the designated constraints aren't met.
type ListHasBalanceDimensionRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListHasBalanceDimensionRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListHasBalanceDimensionRequestMultiError) AllErrors() []error { return m }

// ListHasBalanceDimensionRequestValidationError is the validation error
// returned by ListHasBalanceDimensionRequest.Validate if the designated
// constraints aren't met.
type ListHasBalanceDimensionRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListHasBalanceDimensionRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListHasBalanceDimensionRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListHasBalanceDimensionRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListHasBalanceDimensionRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListHasBalanceDimensionRequestValidationError) ErrorName() string {
	return "ListHasBalanceDimensionRequestValidationError"
}

// Error satisfies the builtin error interface
func (e ListHasBalanceDimensionRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListHasBalanceDimensionRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListHasBalanceDimensionRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListHasBalanceDimensionRequestValidationError{}

// Validate checks the field values on ListHasBalanceDimensionResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListHasBalanceDimensionResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListHasBalanceDimensionResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// ListHasBalanceDimensionResponseMultiError, or nil if none found.
func (m *ListHasBalanceDimensionResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *ListHasBalanceDimensionResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetList() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ListHasBalanceDimensionResponseValidationError{
						field:  fmt.Sprintf("List[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return ListHasBalanceDimensionResponseValidationError{
					field:  fmt.Sprintf("List[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return ListHasBalanceDimensionResponseMultiError(errors)
	}

	return nil
}

// ListHasBalanceDimensionResponseMultiError is an error wrapping multiple
// validation errors returned by ListHasBalanceDimensionResponse.ValidateAll()
// if the designated constraints aren't met.
type ListHasBalanceDimensionResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListHasBalanceDimensionResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListHasBalanceDimensionResponseMultiError) AllErrors() []error { return m }

// ListHasBalanceDimensionResponseValidationError is the validation error
// returned by ListHasBalanceDimensionResponse.Validate if the designated
// constraints aren't met.
type ListHasBalanceDimensionResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListHasBalanceDimensionResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListHasBalanceDimensionResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListHasBalanceDimensionResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListHasBalanceDimensionResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListHasBalanceDimensionResponseValidationError) ErrorName() string {
	return "ListHasBalanceDimensionResponseValidationError"
}

// Error satisfies the builtin error interface
func (e ListHasBalanceDimensionResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListHasBalanceDimensionResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListHasBalanceDimensionResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListHasBalanceDimensionResponseValidationError{}

// Validate checks the field values on HasBalanceDimensionResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *HasBalanceDimensionResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on HasBalanceDimensionResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// HasBalanceDimensionResponseMultiError, or nil if none found.
func (m *HasBalanceDimensionResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *HasBalanceDimensionResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return HasBalanceDimensionResponseMultiError(errors)
	}

	return nil
}

// HasBalanceDimensionResponseMultiError is an error wrapping multiple
// validation errors returned by HasBalanceDimensionResponse.ValidateAll() if
// the designated constraints aren't met.
type HasBalanceDimensionResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m HasBalanceDimensionResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m HasBalanceDimensionResponseMultiError) AllErrors() []error { return m }

// HasBalanceDimensionResponseValidationError is the validation error returned
// by HasBalanceDimensionResponse.Validate if the designated constraints
// aren't met.
type HasBalanceDimensionResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e HasBalanceDimensionResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e HasBalanceDimensionResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e HasBalanceDimensionResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e HasBalanceDimensionResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e HasBalanceDimensionResponseValidationError) ErrorName() string {
	return "HasBalanceDimensionResponseValidationError"
}

// Error satisfies the builtin error interface
func (e HasBalanceDimensionResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sHasBalanceDimensionResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = HasBalanceDimensionResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = HasBalanceDimensionResponseValidationError{}
...
func (m *PageListNftAssetRequest) validate(all bool) error {
	...
	// no validation rules for NameLikeIgnoreCase
