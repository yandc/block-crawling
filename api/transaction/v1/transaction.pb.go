...
var file_api_transaction_v1_transaction_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x86, 0x04, 0x0a, 0x17, 0x50, 0x61,
	...
	0x74, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x61, 0x74, 0x65, 0x32, 0xcf,
	0x0d, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x60,
...
var file_api_transaction_v1_transaction_proto_msgTypes = make([]protoimpl.MessageInfo, 50)
var file_api_transaction_v1_transaction_proto_goTypes = []interface{}{
	...
	(*PageListNftAssetRequest)(nil),             // 35: api.transaction.v1.PageListNftAssetRequest
	(*ClientPageListNftAssetGroupResponse)(nil), // 36: api.transaction.v1.ClientPageListNftAssetGroupResponse
	(*ClientNftAssetGroupResponse)(nil),         // 37: api.transaction.v1.ClientNftAssetGroupResponse
	(*ClientPageListNftAssetResponse)(nil),      // 38: api.transaction.v1.ClientPageListNftAssetResponse
	(*ClientNftAssetResponse)(nil),              // 39: api.transaction.v1.ClientNftAssetResponse
	(*NftAssetRequest)(nil),                     // 40: api.transaction.v1.NftAssetRequest
	(*NftBalanceResponse)(nil),                  // 41: api.transaction.v1.NftBalanceResponse
	(*PageListStatisticRequest)(nil),            // 42: api.transaction.v1.PageListStatisticRequest
	(*PageListStatisticResponse)(nil),           // 43: api.transaction.v1.PageListStatisticResponse
	(*StatisticResponse)(nil),                   // 44: api.transaction.v1.StatisticResponse
	(*StatisticFundRequest)(nil),                // 45: api.transaction.v1.StatisticFundRequest
	(*FundAmountListResponse)(nil),              // 46: api.transaction.v1.FundAmountListResponse
	(*FundAmountResponse)(nil),                  // 47: api.transaction.v1.FundAmountResponse
	(*FundRateListResponse)(nil),                // 48: api.transaction.v1.FundRateListResponse
	(*FundRateResponse)(nil),                    // 49: api.transaction.v1.FundRateResponse
}
var file_api_transaction_v1_transaction_proto_depIdxs = []int32{
	...
	37, // 14: api.transaction.v1.ClientPageListNftAssetGroupResponse.list:type_name -> api.transaction.v1.ClientNftAssetGroupResponse
	39, // 15: api.transaction.v1.ClientPageListNftAssetResponse.list:type_name -> api.transaction.v1.ClientNftAssetResponse
	44, // 16: api.transaction.v1.PageListStatisticResponse.list:type_name -> api.transaction.v1.StatisticResponse
	47, // 17: api.transaction.v1.FundAmountListResponse.list:type_name -> api.transaction.v1.FundAmountResponse
	49, // 18: api.transaction.v1.FundRateListResponse.list:type_name -> api.transaction.v1.FundRateResponse
	23, // 19: api.transaction.v1.Transaction.CreateRecordFromWallet:input_type -> api.transaction.v1.TransactionReq
	24, // 20: api.transaction.v1.Transaction.PageList:input_type -> api.transaction.v1.PageListRequest
	27, // 21: api.transaction.v1.Transaction.GetAmount:input_type -> api.transaction.v1.AmountRequest
	19, // 22: api.transaction.v1.Transaction.GetDappList:input_type -> api.transaction.v1.DappListReq
	16, // 23: api.transaction.v1.Transaction.GetAllOpenAmount:input_type -> api.transaction.v1.OpenAmountReq
	14, // 24: api.transaction.v1.Transaction.GetNonce:input_type -> api.transaction.v1.NonceReq
	11, // 25: api.transaction.v1.Transaction.GetDappListPageList:input_type -> api.transaction.v1.DappPageListReq
	29, // 26: api.transaction.v1.Transaction.PageListAsset:input_type -> api.transaction.v1.PageListAssetRequest
	32, // 27: api.transaction.v1.Transaction.GetBalance:input_type -> api.transaction.v1.AssetRequest
	35, // 28: api.transaction.v1.Transaction.ClientPageListNftAssetGroup:input_type -> api.transaction.v1.PageListNftAssetRequest
	35, // 29: api.transaction.v1.Transaction.ClientPageListNftAsset:input_type -> api.transaction.v1.PageListNftAssetRequest
	40, // 30: api.transaction.v1.Transaction.GetNftBalance:input_type -> api.transaction.v1.NftAssetRequest
	42, // 31: api.transaction.v1.Transaction.PageListStatistic:input_type -> api.transaction.v1.PageListStatisticRequest
	45, // 32: api.transaction.v1.Transaction.StatisticFundAmount:input_type -> api.transaction.v1.StatisticFundRequest
	45, // 33: api.transaction.v1.Transaction.StatisticFundRate:input_type -> api.transaction.v1.StatisticFundRequest
	5,  // 34: api.transaction.v1.Transaction.GetUnspentTx:input_type -> api.transaction.v1.UnspentReq
	2,  // 35: api.transaction.v1.Transaction.GetNftRecord:input_type -> api.transaction.v1.NftRecordReq
	0,  // 36: api.transaction.v1.Transaction.JsonRpc:input_type -> api.transaction.v1.JsonReq
	22, // 37: api.transaction.v1.Transaction.CreateRecordFromWallet:output_type -> api.transaction.v1.CreateResponse
	25, // 38: api.transaction.v1.Transaction.PageList:output_type -> api.transaction.v1.PageListResponse
	28, // 39: api.transaction.v1.Transaction.GetAmount:output_type -> api.transaction.v1.AmountResponse
	20, // 40: api.transaction.v1.Transaction.GetDappList:output_type -> api.transaction.v1.DappListResp
	17, // 41: api.transaction.v1.Transaction.GetAllOpenAmount:output_type -> api.transaction.v1.OpenAmoutResp
	15, // 42: api.transaction.v1.Transaction.GetNonce:output_type -> api.transaction.v1.NonceResp
	12, // 43: api.transaction.v1.Transaction.GetDappListPageList:output_type -> api.transaction.v1.DappPageListResp
	30, // 44: api.transaction.v1.Transaction.PageListAsset:output_type -> api.transaction.v1.PageListAssetResponse
	33, // 45: api.transaction.v1.Transaction.GetBalance:output_type -> api.transaction.v1.ListBalanceResponse
	36, // 46: api.transaction.v1.Transaction.ClientPageListNftAssetGroup:output_type -> api.transaction.v1.ClientPageListNftAssetGroupResponse
	38, // 47: api.transaction.v1.Transaction.ClientPageListNftAsset:output_type -> api.transaction.v1.ClientPageListNftAssetResponse
	41, // 48: api.transaction.v1.Transaction.GetNftBalance:output_type -> api.transaction.v1.NftBalanceResponse
	43, // 49: api.transaction.v1.Transaction.PageListStatistic:output_type -> api.transaction.v1.PageListStatisticResponse
	46, // 50: api.transaction.v1.Transaction.StatisticFundAmount:output_type -> api.transaction.v1.FundAmountListResponse
	48, // 51: api.transaction.v1.Transaction.StatisticFundRate:output_type -> api.transaction.v1.FundRateListResponse
	6,  // 52: api.transaction.v1.Transaction.GetUnspentTx:output_type -> api.transaction.v1.UnspentResponse
	3,  // 53: api.transaction.v1.Transaction.GetNftRecord:output_type -> api.transaction.v1.NftRecordResponse
	1,  // 54: api.transaction.v1.Transaction.JsonRpc:output_type -> api.transaction.v1.JsonResponse
