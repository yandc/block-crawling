...
func wireApp(confServer *conf.Server, confData *conf.Data, confApp *conf.App, confAddressServer *conf.AddressServer,
	...
	data.NewAptTransactionRecordRepo(gormDB)
	data.NewSuiTransactionRecordRepo(gormDB)
	data.NewSolTransactionRecordRepo(gormDB)
	data.NewCkbTransactionRecordRepo(gormDB)
	data.NewCsprTransactionRecordRepo(gormDB)
	data.NewAtomTransactionRecordRepo(gormDB)
	data.NewDotTransactionRecordRepo(gormDB)
